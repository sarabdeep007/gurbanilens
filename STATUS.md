...
_Last updated: 2026-06-20 by Claude (iOS agent) — Phase 2A **v2 Phase A** foundation shipped (Settings toggle, StreamingASR, matchByFirstLetters with phonetic equivalence, .listening/.committing states, minimal LiveResultsScreen). Phase B polish (animated header, VU bar, list transitions) is next._
